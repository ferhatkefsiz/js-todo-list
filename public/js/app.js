...
function addTask(event) {
    if (event.keyCode == 13) {
        ...
        Toastify({
            ...
            gravity: 'bottom',
            position: 'left',
            backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,121,10,1) 0%, rgba(1,240,28,1) 100%, rgba(0,212,255,1) 100%)',
            stopOnFocus: true
        }).showToast()
...
function removeTask(id) {
    ...
    Toastify({
        ...
        gravity: 'bottom',
        position: 'left',
        backgroundColor: 'linear-gradient(90deg, rgba(131,58,180,1) 0%, rgba(238,84,84,1) 0%, rgba(244,57,57,1) 72%, rgba(244,56,56,1)',
        stopOnFocus: true
    }).showToast()
    showTasksList()
}
